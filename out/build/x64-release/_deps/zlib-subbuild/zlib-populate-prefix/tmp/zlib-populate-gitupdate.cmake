...
execute_process(
  COMMAND "C:/Git/cmd/git.exe" --git-dir=.git show-ref "2.1.3"
  WORKING_DIRECTORY "C:/C++/LoginAppProject/out/build/x64-release/_deps/zlib-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/C++/LoginAppProject/out/build/x64-release/_deps/zlib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/C++/LoginAppProject/out/build/x64-release/_deps/zlib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
